...
/**
  ...
  *
  * @checksum - dc625f0d2547e92d7231b61ad96ff6ac035f2d4c8beb635eebf0c8ca28da7343
  * @variables - radius=rounded-full,accentColor=red,colorTemperature=stone,spacing=2.5,scale=base,inputShadow=shadow-sm,baseColorShade=600,borderShadeLightMode=300,borderShadeDarkMode=600,inputMaxWidth=max-w-[24em],tagRadius=rounded-full,swatchRadius=rounded-full
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "color__inner": {
    ...
    "group-data-[prefix-icon]:border-stone-300": true,
    "group-data-[suffix-icon]:border": true,
    "group-data-[suffix-icon]:border-stone-300": true,
    "dark:group-data-[prefix-icon]:border-stone-600": true,
    "dark:group-data-[suffix-icon]:border-stone-600": true
  },
  "color__input": {
    "appearance-none": true,
    "[color-scheme:light]": true,
  ...
  "range__input": {
    ...
    "group/input": true,
    "cursor-pointer": true,
    "[&::-webkit-slider-runnable-track]:bg-stone-300/50": true,
    ...
    "[&::-webkit-slider-thumb]:group-data-[disabled]:!ring-stone-200": true,
    ...
    "[&::-moz-range-track]:bg-stone-300/50": true,
  ...
  "submit__input": {
    ...
    "disabled:border-stone-300": true,
  ...
  "autocomplete__selectionWrapper": {
    ...
    "dark:group-data-[multiple]:border-stone-600": true,
  ...
  "slider__minValue": {
    ...
    "[&>div>div::after]:bg-stone-300": true,
    "dark:[&>div>div::after]:bg-stone-600": true
  },
  "slider__maxValue": {
    "grow": true,
    "!max-w-[45%]": true,
  ...
  "multi-step__tabs": {
    ...
    "dark:group-data-[tab-style=tab]/wrapper:border-stone-700": true,
